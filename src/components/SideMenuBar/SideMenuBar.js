        ...
        >
            <DialogContent className='modal-content'>
                <div className='logout-modal'>
                    {/* Translate Text */}
                    <p className='title'>Are you sure want to logout now ?</p>
                    <div className='btn-container'>
                        <div className='btn-yes' onClick={this._handleLogout}>Yes</div>
                        <div className='btn-no' onClick={() => this.setState({isLogoutModalShow:false})}>No</div>
                    </div>
                </div>
            </DialogContent>
        </Modal>
