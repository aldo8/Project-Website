...
export const listWorkCenterPercentage = (state= {...initialStateWorkCenter},action) => {
    const {payload,type} = action;
    switch (type) {
...
export const listAchievementPercentage = (state= {...initialStateJobType},action) => {
    const {payload,type} = action;
    switch (type) {
...
export const listMonitoring = (state= {...initialStateListMonitor},action) => {
    const {payload,type} = action;
    switch (type) {
...
export const masterDataProblemLog = (state={...initialStateMasterData},action) => {
    const {payload,type}=action;
    switch (type) {
...
export const downloadReportProblemLog = (state={...initialStateDownloadReport},action) => {
    console.log('TAKSI',action)
    const {payload,type} = action;
    switch (type) {
...
export const submitProblemLog = (state={...initialStateApprove},action) => {
    const {payload,type} = action;
    switch (type) {
